...
class Graph {
    ...
    line(x1: number, y1: number, x2: number, y2: number, color: string = '#black', width: number = 1): void {
    ...
    point(x: number, y: number, color: string = '#black', size: number = 2): void {
        this.context.beginPath();
        this.context.strokeStyle = color;
    ...
    polygon(points: Omit<Point, 'z'>[] = [], color: string = '#black'): void {
        this.context.beginPath();
    ...
    triangle(x1: number = 0, y1: number = 0, x2: number = 0, y2: number = 0, x3: number = 0, y3: number = 0, color: string = '#black'): void {
        this.context.beginPath();
        this.context.fillStyle = color;
        this.context.moveTo(this.xs(x1), this.ys(y1));
        this.context.lineTo(this.xs(x2), this.ys(y2));
